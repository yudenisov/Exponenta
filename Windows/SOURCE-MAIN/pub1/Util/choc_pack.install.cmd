...
%Chocolatey%\bin\choco.exe install -y --force --ignore-checksums sysinternals curl wget duck
%Chocolatey%\bin\choco.exe install -y --force --ignore-checksums 7Zip.install 7zip 7zip.portable unxutils
rem
